...
在 VS Code 里，默认是单击在“预览模式”打开，双击才会固定成一个真正的标签页。

如果你想要单击左侧文件，直接打开为一个新的（固定）编辑器标签，而不是预览。

![](https://image.newarea.site/2026-01-07_10-33-55.png)

## 解决 VSCode 快捷键 `F1`（打开控制面板）与 截图工具 Snipaste 快捷键冲突的问题

将 VSCode 快捷键 `F1` 改为 `Ctrl` + `Shift` + `P`

## 关闭 Dart 插件显示 widget 构造函数提示

![](https://image.newarea.site/2025-10-10_14-42-19.png)

![](https://image.newarea.site/2025-10-10_15-00-38.png)

## 设置默认终端

进入配置，搜素 `terminal.integrated.defaultProfile.windows`，选择想要的终端。一般改成 PowerShell。