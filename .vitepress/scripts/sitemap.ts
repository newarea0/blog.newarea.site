...
export function generateSitemapJsonUrlLinks(siteConfig: SiteConfig) {
...
export function generateTodaySitemapTxtUrlLinks(siteConfig: SiteConfig) {
  const writeStream = createWriteStream(
 ...
 * @returns
 */
export function getSiteUrlLinks(id: string, { pageData }: TransformContext) {
 ...
 * @param param0
 */
export async function generateSiteMap({ outDir }: SiteConfig) {
